...
public class SortHashMapByKeyAndValue {
	public static void main(String args[]) throws ParseException {
		...
		codenames.put("JavaSE 7", "Dolphin");
		System.out.println("HashMap before sorting, randomorder ");
		 ...
		 * TreeMap with mappings of HashMap TreeMap keeps all entries in sorted
		 * order
		 */
		...
		/*
		 * Now let's sort the HashMap by values there is no direct way to sort
		 * HashMap by values but you can do this by writing your own comparator,
		 * which takes Map.Entry object and arrange them in order increasing or
		 * decreasing by values.
		 */
