...
public class NotificationTest {
	...
	public static void main(String args[]) throws InterruptedException {
		 ...
		 * Thread.sleep(200);
		 * 
		 * //starting notifying thread t4.start();
		 */
		...
		while (iterator.hasNext()) {
			...
			bookAndPrice.put("My Java Book", 333);
		}
		System.out.println("after removing : " + bookAndPrice);*/
		
		
		String name = "Ramanujan singh chaturvedi";
		System.out.println(name.length() + " - "+ name.substring(name.length()-2, name.length()-2));
